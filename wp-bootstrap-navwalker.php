...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
        ...
        public function dropdown() {
            wp_add_inline_script( "dropdown-js", "jQuery('.dropdown-toggle').click(function(){if (jQuery(this).next().is(':visible')) { location.href = jQuery(this).attr('href');}});");
         }
         add_action( 'wp_enqueue_scripts', 'dropdown' );
		/**
		 * Menu Fallback
		 * =============
